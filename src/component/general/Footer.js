...
function Footer() {
  return (
    <div className="w-full rounded-2xl p-3 text-xs dark:bg-zinc-700 sm:text-sm  md:text-base lg:text-xl">
      ...
      <div className="md:mx-auto md:w-[70%] md:p-4">
        <ul className="flex flex-col gap-1 md:gap-2">
          <p className="mb-1 dark:text-green-400">Our contact information:</p>
          <li className=" flex items-center gap-2  dark:hover:text-green-400">
