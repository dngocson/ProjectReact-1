...
const Product = ({ title, price, id, image }) => {
  ...
  return (
    <div
      ...
      className="z-10 flex h-full cursor-pointer flex-col items-center justify-between rounded-2xl border border-gray-400 bg-blue-300  shadow dark:border-gray-700 dark:bg-gray-800 "
    >
      <div>
        <img
      ...
      <div className="flex h-full w-full flex-col px-5 pb-5">
        ...
        <div className="flex h-full items-end justify-between">
          ...
          <button
            ...
            className=" whitespace-nowrap rounded-lg bg-blue-700 p-2 px-5 text-center text-sm font-medium text-white hover:bg-blue-500 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 md:py-2.5"
          >
            Add to cart
          </button>
        </div>
